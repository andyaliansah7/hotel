...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/stock_out/edit/' + full['id'];
	...
	var renderPrint = function(data, type, full, meta) {
    	var url = APP.siteUrl + 'adm/stock_out/print_out/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/stock_out/delete',
		urlRequestData: window.APP.siteUrl + 'adm/stock_out/get_data_header',
