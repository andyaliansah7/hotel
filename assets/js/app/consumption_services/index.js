...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/consumption_services/edit/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/consumption_services/delete',
		urlRequestData: window.APP.siteUrl + 'adm/consumption_services/get_data_header',
