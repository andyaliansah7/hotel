...
window.FORM_EDIT = (function ($) {
	return {
		...
		// url
        urlPrintOut: window.APP.siteUrl + 'adm/consumption_services/print_out/',
        urlIndex: window.APP.siteUrl + 'adm/consumption_services/',
        urlList: window.APP.siteUrl + 'adm/consumption_services/get_embed',
        urlRequestData: window.APP.siteUrl + 'adm/consumption_services/get_data_detail',
				...
				methods: {
					...
					handleOnBehalf: function () {
						...
						$(".room-select").change(function (e) {
							...
							$.ajax({
								type: "POST",
								url: window.APP.siteUrl + 'adm/consumption_services/get_checkin',
								dataType: "JSON",
								data: {
									id: id
								},
