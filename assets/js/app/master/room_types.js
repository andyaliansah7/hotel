...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/room_types/edit/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/room_types/delete',
		urlRequestData: window.APP.siteUrl + 'adm/room_types/get_data',
