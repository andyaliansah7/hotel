...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/services/edit/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/services/delete',
		urlRequestData: window.APP.siteUrl + 'adm/services/get_data',
