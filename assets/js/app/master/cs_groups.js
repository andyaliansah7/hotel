...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/Cs_groups/edit/' + full['id'];
	...
	return {
		...
		urlActiveRoom: window.APP.siteUrl + 'adm/Cs_groups/room_active',
		urlDeleteData: window.APP.siteUrl + 'adm/Cs_groups/delete',
		urlRequestData: window.APP.siteUrl + 'adm/Cs_groups/get_data',
