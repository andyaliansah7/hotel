...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/consumptions/edit/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/consumptions/delete',
		urlRequestData: window.APP.siteUrl + 'adm/consumptions/get_data',
