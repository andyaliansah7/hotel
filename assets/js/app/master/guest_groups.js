...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/guest_groups/edit/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/guest_groups/delete',
		urlRequestData: window.APP.siteUrl + 'adm/guest_groups/get_data',
