...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/special_rates/edit/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/special_rates/delete',
		urlRequestData: window.APP.siteUrl + 'adm/special_rates/get_data',
