...
window.REPORT = (function ($) {
	...
	return {
		...
		urlRequestData: window.APP.siteUrl + 'adm/r_payments/get_data_detail',
			...
			new Vue({
				...
				methods: {
					getData: function () {
						...
						$.ajax({
							...
							success: function (response) {
								...
								vue.$set(vue, 'detailData3', response['data_guestgroup']);
								vue.$set(vue, 'detailData4', response['data_deposit']);
					...
					exportExcel: function () {
						...
						setTimeout(function () {
							window.location = window.APP.siteUrl + 'adm/r_payments/export_excel';
						}, 500);
					}
				},
				mounted: function () {
