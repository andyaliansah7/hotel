...
window.MASTER = (function ($) {
	...
	var renderPrint = function(data, type, full, meta) {
    	var url = APP.siteUrl + 'adm/payments/print_out/' + full['id'];
        return '<a class="master-edit" href="' + url + '" data-toggle="tooltip" data-placement="right" title="Tekan untuk Print"><i class="fa fa-print btn btn-success btn-xs"></i></a>';
    }

	var renderReceive = function(data, type, full, meta) {
    	var url = APP.siteUrl + 'adm/receive_orders/create/' + full['id'];
        return '<a class="master-edit" href="' + url + '" data-toggle="tooltip" data-placement="right" title="Tekan untuk melakukan Receive Order"><i class="fas fa-tasks btn btn-primary btn-xs"></i></a>';
    }
	...
	return {
		...
		urlRequestData: window.APP.siteUrl + 'adm/payments/get_data_header',
