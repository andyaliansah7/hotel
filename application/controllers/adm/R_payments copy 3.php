	...
	{	
		...
		{	
			...
			{	
				...
				// $kartu = ($total_paid_kartu_1 + $total_paid_kartu_2 + $total_paid_kartu_3) + $total_dep_kartu - ($total_dep_tunai + $total_dep_trans);
				// $tunai = ($total_paid_tunai_1 + $total_paid_tunai_2 + $total_paid_tunai_3) + $total_dep_tunai - ($total_dep_kartu + $total_dep_trans);
				// $trans = ($total_paid_trans_1 + $total_paid_trans_2 + $total_paid_trans_3) + $total_dep_trans - ($total_dep_kartu + $total_dep_tunai);				
				
				$kartu = ($total_paid_kartu_1 + $total_paid_kartu_2 + $total_paid_kartu_3) + ($total_dep_kartu);
				$tunai = ($total_paid_tunai_1 + $total_paid_tunai_2 + $total_paid_tunai_3) + ($total_dep_tunai);
				$trans = ($total_paid_trans_1 + $total_paid_trans_2 + $total_paid_trans_3) + ($total_dep_trans);
